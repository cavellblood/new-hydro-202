...
export const DEFAULT_BUTTON_STYLES = clsx([
  'flex h-[2.5rem] duration-200 ease-out items-center justify-center overflow-hidden rounded-full bg-brand-500 p-4 text-sm font-bold text-white disabled:opacity-20',
  'hover:opacity-80',
]);
